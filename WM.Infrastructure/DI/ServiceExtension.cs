...
namespace WM.Infrastructure.DI
{
    /// <summary>
    ...
    public static class ServiceExtension
    {
        ...
        /// <returns></returns>
        public static IServiceCollection RegisterAssembly(this IServiceCollection service, string interfaceAssemblyName, ServiceLifetime serviceLifetime = ServiceLifetime.Transient)
        {
            if (service == null)
        ...
        /// <returns></returns>
        public static IServiceCollection RegisterAssembly(this IServiceCollection service, string interfaceAssemblyName, string implementAssemblyName, ServiceLifetime serviceLifetime = ServiceLifetime.Transient)
        {
            if (service == null)
                throw new ArgumentNullException(nameof(service));
            if (string.IsNullOrEmpty(interfaceAssemblyName))
